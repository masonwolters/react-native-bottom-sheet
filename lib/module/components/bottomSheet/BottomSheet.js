...
import { cancelAnimation, Extrapolation, interpolate, ReduceMotion, useAnimatedReaction, useDerivedValue, useReducedMotion, useSharedValue } from 'react-native-reanimated';
...
const BottomSheetComponent = /*#__PURE__*/forwardRef(function BottomSheet(props, ref) {
  ...
  const handleSnapToIndex = useStableCallback(function handleSnapToIndex(index, animationConfigs) {
     ...
     */
    isInTemporaryPosition.value = false;
    scheduleOnUI(animateToPosition, targetPosition, ANIMATION_SOURCE.USER, 0, animationConfigs);
  });
